...
img = img_as_ubyte(io.imread("monkey.jpg", as_gray=True))
...
print(img[0, 0])  # reports pixel value at 0,0. Remove img_as_ubyte and see the value.
...
img = img_as_ubyte(io.imread("nucleiTubolin_small_noisy.jpg", as_gray=True))
img1 = img_as_ubyte(io.imread("test_image.jpg", as_gray=True))
img2 = img_as_ubyte(io.imread("aeroplane/1.jpg", as_gray=False))
